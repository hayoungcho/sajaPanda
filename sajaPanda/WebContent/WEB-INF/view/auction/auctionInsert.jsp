...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f02ddfa08ad3a34b08b53cfc78e4dda9&libraries=services"></script>
<script type="text/javascript">
  ...
  /* 
   function inputNumberOnly(obj){
	   console.log("숫자 체크1 >>> "+obj.value);
	   console.log("숫자 체크2 >>> "+$(this).val());
		var reg = /[^0-9]/gi;
		var v = $(this).val();
        $(this).focus();
        if (reg.test(v)) {
