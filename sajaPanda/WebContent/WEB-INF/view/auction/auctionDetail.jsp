...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		console.log("compareDate.getDate() >>>  " + compareDate.getDate());
		...
		//서버시간의 에포크 시간을 구해 클라이언트 시간 차이 계산 
		...
		function timeBetweenDates(toDate, timeDiff) {
			...
			// 시간 차이를 getTime으로 milliseconds단위로 계산 
